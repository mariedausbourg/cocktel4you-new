          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, x: -40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }}>
              ...
              <p className="text-muted-foreground leading-relaxed text-lg mb-5">
                Cocktel4you est né de la conviction que chaque smartphone mérite une seconde chance. Fondée en 2015 par François Ravet, notre boutique est devenue la référence de la réparation express au centre-ville.
              </p>
              <p className="text-muted-foreground leading-relaxed mb-6">
                Avec plus de 10 000 appareils réparés et 312 avis positifs, nous avons construit une réputation solide basée sur la qualité, la rapidité et la transparence. Notre équipe de techniciens certifiés prend en charge votre appareil avec le plus grand soin.
              </p>
              <div className="grid grid-cols-3 gap-4">
                {[{ n: '10 000+', l: 'Réparations' }, { n: '11 ans', l: "D'expérience" }, { n: '4,6/5', l: 'Note clients' }].map((s) => (
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto section-padding">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center mb-14">
            ...
            <p className="text-muted-foreground max-w-lg mx-auto">François Ravet met son expérience et son exigence au service de chaque client, avec un accompagnement sérieux, rapide et transparent.</p>
          </motion.div>
