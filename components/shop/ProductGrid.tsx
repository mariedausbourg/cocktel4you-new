...
import { products, productCategories, type Product, type ProductCategory } from '@/lib/data/products';
...
export default function ProductGrid() {
  ...
  const categories: (ProductCategory | 'Tous')[] = ['Tous', ...productCategories];
                  ...
                  cart.map(({ product, qty }) => (
                    <div key={product.id} className="flex gap-3 p-3 rounded-xl bg-muted/40">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm font-bold text-brand-violet-500 mt-0.5">{product.price.toFixed(2)}€</p>
